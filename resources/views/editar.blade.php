...
<nav class="navbar bg-light">
    <div class="container-fluid">
        ...
        <a href="{{ route('usuarios.index')}}" class="btn btn-info">Registros</a>
    </div>
</nav>
...
<div class="container">
    <div class="row">
        ...
        @endif
        <h1 class="mt-5 mb-5">Editar PC & Usuario</h1>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('usuarios.update', $usuario) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="mac" id="mac" value="{{ $usuario->mac }}">
                        @error('mac')
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="ip" id="ip" value="{{ $usuario->ip }}">
                        @error('ip')
                        <span class="text-danger">{{ $message  }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="pcnombre" id="pcnombre" value="{{ $usuario->pcnombre }}">
                        @error('pcnombre')
                        <span class="text-danger">{{ $message  }}</span>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" name="departamento" id="departamento" value="{{ $usuario->departamento }}">
                    </div>
